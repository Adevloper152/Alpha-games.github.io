...
console.log('CookiePAGE Value: ' + Setting14b + 'alpha-games-Scripts Loaded')
checkPageClose2()
...
const settingsDefaultTab = {
  title: 'Settings - A tooler',
  icon: 'https://github.com/alpha-games/home/blob/main/G.png?raw=true',
}
...
// Security checks
const blacklistedDomains = ['alpha-games.net', 'alpha-games.github.io']
...
function showSecurityWarning() {
  ...
  warning.textContent = 'You Are Accessing A tooler From A Blacklisted Domain (A Fake A tooler Site)'
  document.body.appendChild(warning)

  const button = document.createElement('button')
  button.textContent = 'Go To A tooler'
  button.onclick = () => window.open('https://alpha-games.github.io', '_blank')
